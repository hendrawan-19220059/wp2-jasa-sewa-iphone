<div class="container">
    <h1 class="mt-3">Data Perangkat</h1>
            ...
            <tr>
                ...
                <td>
                    <div class="btn-group tombol mx-auto" role="group" aria-label="Basic mixed styles example">
                        <a href="<?= base_url(); ?>data/perangkat/<?= $p['kode_perangkat']; ?>" class="btn btn-success">Show</a>
                        <a href="<?= base_url(); ?>data/perangkat/update/<?= $p['kode_perangkat']; ?>" class="btn btn-primary">Update</a>
                        <a href="<?= base_url(); ?>data/perangkat/delete/<?= $p['id']; ?>" class="btn btn-danger " onclick="return confirm('Yakin ingin dihapus?'); ">Delete</a>
                    </div>
                </td>
            </tr>
            <?php endforeach; ?>
